...
<script>
	...
	import { getFieldsList, getArticleList, addCart, cartList } from '@/api'
	import qs from 'qs'
...
<style>
	...
	.float-author {
		...
		padding: 13px 42px;
		z-index: 2;
		box-shadow: 0px 0px 43px #e4dede;
	}

	.work-author:hover div.float-author {
		display: block;
	}
	...
	.works-right-wrap>p:nth-of-type(1) {
		width: 100%;
		text-align: center;
		margin-bottom: 18px;
	}
